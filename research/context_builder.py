...
def build_kimono_prompt(month: int | None = None, seed: int | None = None) -> str:
    ...
    return f"she is wearing a traditional Japanese kimono (着物), entirely {k['color']} kimono with single color scheme throughout, wide kimono sleeves and formal Japanese draping, {k['pattern']}, paired with {k['obi']} obi sash, NOT western clothes"
